var Verify = function (window, document) {
  function verify (options) { // 创建一个图形验证码对象，接收options对象为参数
  ...
  verify.prototype = {
    ...
    refresh: function () {
      ...
      /** 绘制干扰点**/
      for (var k = 0; k < this.options.width / 4; k++) {
...
export default Verify(window, document)
